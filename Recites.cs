...
{ //MainLauncher = true, 
    [Activity(Label = "القرآن الكريم", MainLauncher = true, Icon = "@drawable/icon")]
    public class Recites : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            tableItems = recitesn.AutherList();
        ...
        void OnListItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            // Android.Widget.Toast.MakeText(this, t.RealName, Android.Widget.ToastLength.Short).Show();
            Intent intent = new Intent(this, typeof(AyA));
            intent.PutExtra("Recites", t.ServerName);
            StartActivity(intent);
        }

        //عندما يعطي خطأ يكون السبب ان الكلاس المأخوذ منه يجب ان يكون
        //public
